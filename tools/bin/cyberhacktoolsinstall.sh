...
# (9.) COMET-BASH-root> echo deb http://http.kali.org/kali kali-rolling main contrib non-free >> /etc/apt/sources.list && apt-get update -y && apt-get upgrade -y && apt-get dist-upgrade -y && $STARTUPDIR/mybackgroundwllpservice.sh && $STARTUPDIR/mycometdesignRDP.sh && $STARTUPDIR/mycometdesignTerminal.sh; echo END [9]
...
mypaint --version > $HTOOLLOGS; echo " " >> $HTOOLLOGS; nmap -v >> $HTOOLLOGS; echo " " >> $HTOOLLOGS; wireshark -v | grep Wireshark >> $HTOOLLOGS; echo " " >> $HTOOLLOGS; netdiscover -h | head -1 >> $HTOOLLOGS; echo " " >> $HTOOLLOGS; ettercap -v| grep ettercap >> $HTOOLLOGS; echo " " >> $HTOOLLOGS; amass -version >> $HTOOLLOGS; echo " " >> $HTOOLLOGS; rkhunter -V | grep Root >> $HTOOLLOGS; echo " " >> $HTOOLLOGS; cisco-torch -V >> $HTOOLLOGS; echo " " >> $HTOOLLOGS; lynis -V >> $HTOOLLOGS; echo " " >> $HTOOLLOGS; above | grep Version >> $HTOOLLOGS; echo " " >> $HTOOLLOGS; masscan | grep usage >> $HTOOLLOGS; echo " " >> $HTOOLLOGS; firewalk -v | grep version >> $HTOOLLOGS; echo " " >> $HTOOLLOGS; fierce -h | grep usage >> $HTOOLLOGS; echo " " >> $HTOOLLOGS; netmask -v >> $HTOOLLOGS; echo " " >> $HTOOLLOGS; hping3 -v >> $HTOOLLOGS; echo " " >> $HTOOLLOGS; netcat -v >> $HTOOLLOGS; echo " " >> $HTOOLLOGS; ffuf -V >> $HTOOLLOGS; echo " " >> $HTOOLLOGS; tcpdump --version >> $HTOOLLOGS; echo " " >> $HTOOLLOGS; nbtscan -h | grep Human >> $HTOOLLOGS; echo " " >> $HTOOLLOGS; hashcat -V >> $HTOOLLOGS; echo " " >> $HTOOLLOGS; ls -artl /usr/bin/mimikatz >> $HTOOLLOGS; echo " " >> $HTOOLLOGS; john -h | grep John >> $HTOOLLOGS; echo " " >> $HTOOLLOGS; ophcrack -h | grep securite
 >> $HTOOLLOGS; echo " " >> $HTOOLLOGS; fcrackzip -h | grep "fcrackzip v" >> $HTOOLLOGS; echo " " >> $HTOOLLOGS; hydra -h | grep "Hydra v"
 >> $HTOOLLOGS; echo " " >> $HTOOLLOGS; gobuster version >> $HTOOLLOGS; echo " " >> $HTOOLLOGS; bloodhound | grep futex >> $HTOOLLOGS; echo " " >> $HTOOLLOGS; crackmapexec | grep Version
 >> $HTOOLLOGS; echo " " >> $HTOOLLOGS; evil-winrm -v >> $HTOOLLOGS; echo " " >> $HTOOLLOGS; enum4linux -h | grep enum4linux >> $HTOOLLOGS; echo " " >> $HTOOLLOGS; shellter -v_pb >> $HTOOLLOGS; echo " " >> $HTOOLLOGS; smbmap | grep Samba >> $HTOOLLOGS; echo " " >> $HTOOLLOGS; wpscan --version | grep Current >> $HTOOLLOGS; echo " " >> $HTOOLLOGS; ls -artl /usr/bin/dirbuster >> $HTOOLLOGS; echo " " >> $HTOOLLOGS; cewl -v | grep CeWL >> $HTOOLLOGS; echo " " >> $HTOOLLOGS; dnsrecon -V >> $HTOOLLOGS; echo " " >> $HTOOLLOGS; dnsenum | grep VERSION >> $HTOOLLOGS; echo " " >> $HTOOLLOGS; whatweb | grep version >> $HTOOLLOGS; echo " " >> $HTOOLLOGS; parsero | grep usage >> $HTOOLLOGS; echo " " >> $HTOOLLOGS; ls -artl /usr/bin/lbd >> $HTOOLLOGS; echo " " >> $HTOOLLOGS; ls -artl /usr/bin/dirsearch >> $HTOOLLOGS; echo " " >> $HTOOLLOGS; subfinder -version >> $HTOOLLOGS; echo " " >> $HTOOLLOGS; httrack -h | grep HTTrack | head -1 >> $HTOOLLOGS; echo " " >> $HTOOLLOGS; dmitry -v | grep Version >> $HTOOLLOGS; echo " " >> $HTOOLLOGS; wfuzz --version >> $HTOOLLOGS; echo " " >> $HTOOLLOGS; ls -artl /usr/bin/sublist3r >> $HTOOLLOGS; echo " " >> $HTOOLLOGS; skipfish -h | grep version >> $HTOOLLOGS; echo " " >> $HTOOLLOGS; nikto -Version >> $HTOOLLOGS; echo " " >> $HTOOLLOGS; crunch -v >> $HTOOLLOGS; echo " " >> $HTOOLLOGS; ls -artl /usr/bin/theharvester >> $HTOOLLOGS; echo " " >> $HTOOLLOGS; ls -artl /etc/skel/.config/powershell/Microsoft.PowerShell_profile.ps1 >> $HTOOLLOGS; echo " " >> $HTOOLLOGS; responder --version | tail -1 >> $HTOOLLOGS; echo " " >> $HTOOLLOGS; snort -V | grep Version >> $HTOOLLOGS; echo " " >> $HTOOLLOGS; macchanger -v >> $HTOOLLOGS; echo " " >> $HTOOLLOGS; impacket-scripts -v_pb >> $HTOOLLOGS; echo " " >> $HTOOLLOGS; chntpw | grep "chntpw version" >> $HTOOLLOGS; echo " " >> $HTOOLLOGS; ls -artl /usr/share/wordlists >> $HTOOLLOGS; echo " " >> $HTOOLLOGS; eyewitness | grep usage >> $HTOOLLOGS; echo " " >> $HTOOLLOGS; ls -artl /usr/bin/trufflehog >> $HTOOLLOGS; echo " " >> $HTOOLLOGS; chisel -v >> $HTOOLLOGS; echo " " >> $HTOOLLOGS; ncat -v >> $HTOOLLOGS; echo " " >> $HTOOLLOGS; /usr/share/lintian/overrides/openssh-client >> $HTOOLLOGS; echo " " >> $HTOOLLOGS; yersinia -V | grep yersinia
 >> $HTOOLLOGS; echo " " >> $HTOOLLOGS; havoc | grep Version >> $HTOOLLOGS; echo " " >> $HTOOLLOGS; ls -artl /usr/bin/veil >> $HTOOLLOGS; echo " " >> $HTOOLLOGS; msfvenom -h >> $HTOOLLOGS; echo " " >> $HTOOLLOGS; ldapsearch -V >> $HTOOLLOGS; echo " " >> $HTOOLLOGS; ls -artl /usr/bin/burpsuite >> $HTOOLLOGS; echo " " >> $HTOOLLOGS; msfrpcd -h | grep Usage >> $HTOOLLOGS
#
#Cleaning:
apt-get clean
#
