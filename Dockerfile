...
RUN echo $STARTUPDIR\/myfirefoxservice\.sh containered >> /home/$USERVNC/.bashrc && echo $STARTUPDIR\/myscreenstreched\.sh >> /home/$USERVNC/.bashrc && echo $STARTUPDIR\/myfirefoxservice\.sh >> /root/.bashrc && echo 'export USERCOMET='$USERVNC >> /home/$USERVNC/.bashrc && echo 'export USERCOMET='$USERVNC >> /root/.bashrc && echo 'export STARTUPDIR='$STARTUPDIR >> /home/$USERVNC/.bashrc && echo 'export STARTUPDIR='$STARTUPDIR >> /root/.bashrc && echo "alias ll='ls -artl'" >> /home/$USERVNC/.bashrc && echo "alias ll='ls -artl'" >> /root/.bashrc && cp /home/$USERVNC/.bashrc /home/$USERVNC/.bashrc_comet && cp /root/.bashrc /root/.bashrc_comet
RUN echo ACTION\=\$1 > $STARTUPDIR/myfirefoxsvc.sh && echo if \! \[ \-f "$HOME/.firefoxtmp" \]\; then >> $STARTUPDIR/myfirefoxsvc.sh && echo exit >> $STARTUPDIR/myfirefoxsvc.sh && echo fi >> $STARTUPDIR/myfirefoxsvc.sh && echo if \[ \"\$ACTION\" \= \"special\" \]\; then >> $STARTUPDIR/myfirefoxsvc.sh && echo ACTION\=containered  >> $STARTUPDIR/myfirefoxsvc.sh && echo rm "$HOME/.fftwice"  >> $STARTUPDIR/myfirefoxsvc.sh && echo fi >> $STARTUPDIR/myfirefoxsvc.sh && echo if \[ \"\$ACTION\" \= \"containered\" \]\; then >> $STARTUPDIR/myfirefoxsvc.sh && echo if \! \[ \-f "$HOME/.fftwice" \]\; then >> $STARTUPDIR/myfirefoxsvc.sh && echo "rm $HOME/.firefoxtmp" >> $STARTUPDIR/myfirefoxsvc.sh && echo if \! \[ \"\$1\" \= \"special\" \]\; then >> $STARTUPDIR/myfirefoxsvc.sh && echo "$STARTUPDIR/myfirefoxservice.sh containered &" >> $STARTUPDIR/myfirefoxsvc.sh && echo "sleep 15" >> $STARTUPDIR/myfirefoxsvc.sh && echo "$STARTUPDIR/myfirefoxservice.sh containered &" >> $STARTUPDIR/myfirefoxsvc.sh && echo fi >> $STARTUPDIR/myfirefoxsvc.sh && echo "touch $HOME/.fftwice" >> $STARTUPDIR/myfirefoxsvc.sh && echo fi >> $STARTUPDIR/myfirefoxsvc.sh && echo fi >> $STARTUPDIR/myfirefoxsvc.sh && chmod 755 $STARTUPDIR/myfirefoxsvc.sh
...
RUN touch $STARTUPDIR/mycometdesignTerminal.sh && touch $STARTUPDIR/mycometdesignUserTerminal.sh && echo "cp /home/$user/.bashrc /home/$user/.bashrc_\$\(date \'\+\%Y\%m\%d\_\%H\_\%M\_\%S\'\)" >> $STARTUPDIR/mycometdesignUserTerminal.sh && echo "cp /home/$user/bashrc_comet /home/$user/.bashrc" >> $STARTUPDIR/mycometdesignUserTerminal.sh && echo "cp /root/.bashrc /root/.bashrc_\$\(date \'\+\%Y\%m\%d\_\%H\_\%M\_\%S\'\)" >> $STARTUPDIR/mycometdesignTerminal.sh && echo "cp /root/.bashrc_comet /root/.bashrc" >> $STARTUPDIR/mycometdesignTerminal.sh && echo "cp /root/.bashrc.original /root/.bashrc" >> $STARTUPDIR/mycometdesignTerminal.sh && touch ~/.hushlogin >> $STARTUPDIR/mycometdesignTerminal.sh && chmod 755 $STARTUPDIR/mycometdesignTerminal.sh && chmod 755 $STARTUPDIR/mycometdesignUserTerminal.sh && chmod 755 /home/$USERVNC/.bashrc && chmod 755 /home/$USERVNC/.bashrc_comet && chmod 755 /root/.bashrc && chmod 755 /root/.bashrc_comet && chown $USERVNC:$USERVNC /home/$USERVNC/.bashrc && chown $USERVNC:$USERVNC /home/$USERVNC/.bashrc_comet && touch ~/.hushlogin
