...
RUN echo "rm $HOME/.firefoxtmp" >> $STARTUPDIR/myfirefoxsvc.sh && echo "$STARTUPDIR/myfirefoxservice.sh" >> $STARTUPDIR/myfirefoxsvc.sh && chmod 755 $STARTUPDIR/myfirefoxsvc.sh
