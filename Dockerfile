...
RUN echo touch $STARTUPDIR/myrdpservice.sh && echo sudo \/usr\/bin\/pkill xrdp >> $STARTUPDIR/myrdpservice.sh && echo sudo \/usr\/sbin\/service xrdp restart >> $STARTUPDIR/myrdpservice.sh && echo $STARTUPDIR\/mycometdesignRDP\.sh >> $STARTUPDIR/myrdpservice.sh && chmod 755 $STARTUPDIR/myrdpservice.sh
