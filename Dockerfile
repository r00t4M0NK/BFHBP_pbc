...
RUN echo cp $HOME/tmp.txt $HOME/.tmplst >> $STARTUPDIR/myfirefoxservice.sh && echo cp $HOME/tmp2.txt $HOME/.tmp2lst >> $STARTUPDIR/myfirefoxservice.sh && echo rm \-f $HOME\/tmp\.txt 2\>\/dev\/null >> $STARTUPDIR/myfirefoxservice.sh && echo rm \-f $HOME\/tmp2\.txt 2\>\/dev\/null >> $STARTUPDIR/myfirefoxservice.sh
