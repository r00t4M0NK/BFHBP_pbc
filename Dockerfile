...
RUN touch $STARTUPDIR/mycometdesignTerminal.sh && touch $STARTUPDIR/mycometdesignUserTerminal.sh && echo "cp /home/$user/.bashrc /home/$user/.bashrc_\`echo \$(date '+%Y%m%d_%H_%M_%S)\`" >> $STARTUPDIR/mycometdesignUserTerminal.sh && echo "cp /home/$user/bashrc_comet /home/$user/.bashrc" >> $STARTUPDIR/mycometdesignUserTerminal.sh && echo "cp /root/.bashrc /root/.bashrc_\`echo \$(date '+%Y%m%d_%H_%M_%S')\`" >> $STARTUPDIR/mycometdesignTerminal.sh && echo "cp /root/.bashrc_comet /root/.bashrc" >> $STARTUPDIR/mycometdesignTerminal.sh && echo "cp /root/.bashrc.original /root/.bashrc" >> $STARTUPDIR/mycometdesignTerminal.sh && touch ~/.hushlogin >> $STARTUPDIR/mycometdesignTerminal.sh && chmod 755 $STARTUPDIR/mycometdesignTerminal.sh && chmod 755 $STARTUPDIR/mycometdesignUserTerminal.sh && chmod 755 /home/$USERVNC/.bashrc && chmod 755 /home/$USERVNC/.bashrc_comet && chmod 755 /root/.bashrc && chmod 755 /root/.bashrc_comet && chown $USERVNC:$USERVNC /home/$USERVNC/.bashrc && chown $USERVNC:$USERVNC /home/$USERVNC/.bashrc_comet && touch ~/.hushlogin
