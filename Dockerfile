...
RUN echo if \[ \"\$1\" \= \"containered\" \]\; then > $STARTUPDIR/myfirefoxsvc.sh && echo if \! \[ \-f "$HOME/.fftwice" \]\; then >> $STARTUPDIR/myfirefoxsvc.sh && echo "rm $HOME/.firefoxtmp" >> $STARTUPDIR/myfirefoxsvc.sh && echo "$STARTUPDIR/myfirefoxservice.sh" >> $STARTUPDIR/myfirefoxsvc.sh && echo "sleep 15" >> $STARTUPDIR/myfirefoxsvc.sh && echo "$STARTUPDIR/myfirefoxservice.sh" >> $STARTUPDIR/myfirefoxsvc.sh && echo "touch $HOME/.fftwice" >> $STARTUPDIR/myfirefoxsvc.sh && echo fi >> $STARTUPDIR/myfirefoxsvc.sh && echo fi >> $STARTUPDIR/myfirefoxsvc.sh && chmod 755 $STARTUPDIR/myfirefoxsvc.sh
